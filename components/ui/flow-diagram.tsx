      ...
      >
        ...
        >
          ...
          >
            ...
            <path
              d="M -60 -35 L -34 -35 L -22 -23 L -22 13 L -60 13 Z"
              fill="none"
            ...
            {/* Faint Grey Lines */}
            <line x1="-12" y1="-8" x2="55" y2="-8" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" />
            <line x1="-12" y1="4" x2="32" y2="4" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" />
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="0" y="30" textAnchor="middle" fill="#FF3B4E" fontSize="7.5" fontWeight="700" fontFamily="sans-serif">
              Sensitive Data — PII,
            </text>
            <text x="0" y="39" textAnchor="middle" fill="#FF3B4E" fontSize="7.5" fontWeight="700" fontFamily="sans-serif">
              confidential info
            </text>
          </g>
            ...
            <g>
              ...
              >
                <svg
                  ...
                  width={NODE_W}
                  height={NODE_H}
                  viewBox="40 70 432 355"
                  overflow="visible"
                >
                  <defs>
                    <linearGradient id="ws-frame" x1="0" y1="0" x2="1" y2="1">
                      <stop offset="0" stopColor="#ffffff" />
                      <stop offset=".18" stopColor="#d8dcdc" />
                      <stop offset=".48" stopColor="#aeb3b3" />
                      <stop offset=".75" stopColor="#f7f8f8" />
                      <stop offset="1" stopColor="#b9bdbd" />
                    </linearGradient>
                    <linearGradient id="ws-bezel" x1="0" y1="0" x2="1" y2="0">
                      <stop offset="0" stopColor="#161a1a" />
                      <stop offset=".22" stopColor="#4f5454" />
                      <stop offset=".42" stopColor="#bfc4c4" />
                      <stop offset=".52" stopColor="#777c7c" />
                      <stop offset=".7" stopColor="#3b4040" />
                      <stop offset="1" stopColor="#111414" />
                    </linearGradient>
                    <linearGradient id="ws-stand" x1="0" y1="0" x2="1" y2="0">
                      <stop offset="0" stopColor="#171b1b" />
                      <stop offset=".28" stopColor="#686d6d" />
                      <stop offset=".5" stopColor="#e2e5e5" />
                      <stop offset=".62" stopColor="#8d9292" />
                      <stop offset="1" stopColor="#171a1a" />
                    </linearGradient>
                    <radialGradient id="ws-green" cx="35%" cy="30%">
                      <stop offset="0" stopColor="#c6ff55" />
                      <stop offset=".45" stopColor="#72e817" />
                      <stop offset="1" stopColor="#35a900" />
                    </radialGradient>
                    <filter id="ws-outerGlow" x="-30%" y="-30%" width="160%" height="160%">
                    ...
                    <filter id="ws-greenGlow" x="-200%" y="-200%" width="400%" height="400%">
                  ...
                  <rect
                    ...
                    stroke="url(#ws-frame)"
                    strokeWidth="3.2"
                    filter="url(#ws-outerGlow)"
                  />
                  <path
                    d="M50.5 93 Q50.5 79.5 64 79.5 H448 Q461.5 79.5 461.5 93 V318.5 H50.5Z"
                    fill="#050909"
                  />
                  <path
                    d="M50.5 319 H461.5 V344 Q461.5 357.5 448 357.5 H64 Q50.5 357.5 50.5 344Z"
                    fill="url(#ws-bezel)"
                  />
                  <line
                    x1="51"
                  ...
                  />
                  <path
                    d="M59 345 Q59 353 69 353 H438 Q453 353 453 343"
                    fill="none"
                    stroke="#f4f6f6"
                    strokeWidth="1.2"
                    opacity=".7"
                  ...
                  <circle
                    ...
                    r="4.2"
                    fill="url(#ws-green)"
                    filter="url(#ws-greenGlow)"
                  />
                  <circle cx="442.8" cy="340.8" r="1" fill="#d6ff8b" opacity=".8" />
                  <path d="M243 358 L235 416 H277 L269 358 Z" fill="url(#ws-stand)" />
                  <path d="M251 360 L246 413" stroke="#f5f7f7" strokeWidth="1.2" opacity=".7" />
                  <path d="M265 360 L272 413" stroke="#111515" strokeWidth="1.2" opacity=".8" />
                  <path
                    d="M218 416.5 H294"
                    stroke="url(#ws-stand)"
                    strokeWidth="5"
                  ...
                  />
                  <path d="M64 77.8 H448" stroke="#ffffff" strokeWidth="1" opacity=".65" />
                  <path d="M48.8 93 V342" stroke="#ffffff" strokeWidth="1" opacity=".45" />
                </svg>
              </g>
            </g>
